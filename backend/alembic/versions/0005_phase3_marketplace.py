"""Add Phase 3 marketplace mechanics (ledger-only) tables.

Revision ID: 0005_phase3_marketplace
Revises: 0004_phase2_operations_compliance
...
revision: str = "0005_phase3_marketplace"
down_revision: str | None = "0004_phase2_operations_compliance"
